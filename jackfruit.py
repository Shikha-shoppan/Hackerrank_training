...
#However, the festival is only D days away, and he can process only one jackfruit per day. Given the weights of the jackfruits he has collected, help Chackochan calculate the maximum amount of jackfruit jam (in kg) he can prepare before the festival.
#Input:
